...
You can learn more about records in the [C# language reference article for the record type](../language-reference/builtin-types/record.md) and the [record type specification](~/_csharpstandard/standard/classes.md#1516-synthesized-record-class-members) and [record struct specification](~/_csharpstandard/standard/structs.md#164-synthesized-record-struct-members).
